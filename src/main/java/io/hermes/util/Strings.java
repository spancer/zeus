...
public class Strings {
  ...
  public static final ImmutableSet<Character> INVALID_FILENAME_CHARS =
      ImmutableSet.of('\\', '/', '*', '?', '"', '<', '>', '|', ' ', ',');
   ...
   *                     format ("en", "en_UK", etc); also accepts spaces as separators, as an
   ...
   * the delimiter (neither element includes the delimiter); or <code>null</code> if the delimiter
   * wasn't found in the given input String
   */
   ...
   *                      split operation (typically the quotation mark symbol), or
