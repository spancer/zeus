 ...
 * the form <tt>${name}</tt>. Using <tt>PropertyPlaceholder</tt> these placeholders can be
 * substituted for user-supplied values.
 * <p/>
 * <p>
 * Values for substitution can be supplied using a {@link Properties} instance or using a {@link
 * PlaceholderResolver}.
 *
 * @author spancer.ray
 */
public class PropertyPlaceholder {
   ...
   *                                       ignored (<code>true</code>) or cause an exception
   *                                       (<code>false</code>).
   */
  public PropertyPlaceholder(String placeholderPrefix, String placeholderSuffix,
  ...
  /**
   * Replaces all placeholders of format <code>${name}</code> with the value returned from the
