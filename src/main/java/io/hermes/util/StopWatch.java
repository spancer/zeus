 ...
 * <p/>
 * <p>
 * Conceals use of <code>System.currentTimeMillis()</code>, improving the readability of application
...
public class StopWatch {
   ...
   * StopWatch for millions of intervals, or the task info structure will consume excessive memory.
   * Default is "true".
   */
   ...
   * at least one pair {@link #start()} / {@link #stop()} methods.
   *
   * @see #start()
   */
