 ...
 *
 * <p>
 * Best constructed using {@link #binaryJsonBuilder()}. When used to create source for
 * actions/operations, it is recommended.
 *
 * @author spancer.ray
 */
@NotThreadSafe
public abstract class JsonBuilder<T extends JsonBuilder> {
  ...
  private final static DateTimeFormatter defaultDatePrinter =
  ...
  public T field(String name, ReadableInstant date, DateTimeFormatter formatter)
      throws IOException {
    field(name);
