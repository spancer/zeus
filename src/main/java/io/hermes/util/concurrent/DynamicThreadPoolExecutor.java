...
public class DynamicThreadPoolExecutor extends ThreadPoolExecutor {
   ...
   * handoff designs, in which a tasks is only queued if there is an available thread to pick it
   * up.
   * <p/>
   ...
   * left up to one of the {@link RejectedExecutionHandler} policies:
   * <ol>
