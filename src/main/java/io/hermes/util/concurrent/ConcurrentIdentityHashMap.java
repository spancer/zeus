...
/**
 * An alternative identity-comparing {@link ConcurrentMap} which is similar to {@link
...
public final class ConcurrentIdentityHashMap<K, V> extends AbstractMap<K, V>
   ...
   * default reference types (weak keys, strong values), and concurrencyLevel (16).
   *
  ...
  /**
   * Creates a new, empty map with the specified initial capacity, and with default reference types
   * (weak keys, strong values), load factor (0.75) and concurrencyLevel (16).
   *
   * @param initialCapacity the initial capacity. The implementation performs internal sizing to
   *                        accommodate this many elements.
  ...
  /**
   * Creates a new, empty map with a default initial capacity (16), reference types (weak keys,
   * strong values), default load factor (0.75) and concurrencyLevel (16).
   */
   ...
   * hash functions. This is critical because ConcurrentReferenceHashMap uses power-of-two length
   * hash tables, that otherwise encounter collisions for hashCodes that do not differ in lower or
   * upper bits.
   */
   ...
   * compatibility with class {@link Hashtable}, which supported this method prior to introduction
  ...
  static final class Segment<K, V> extends ReentrantLock {
     ...
     * always <tt>(capacity * loadFactor)</tt>.)
     */
    int threshold;
    /**
  ...
  final class WriteThroughEntry extends SimpleEntry<K, V> {
     ...
     * removed in which case the put will re-establish). We do not and can not guarantee more.
     */
    @Override
    public V setValue(V value) {
