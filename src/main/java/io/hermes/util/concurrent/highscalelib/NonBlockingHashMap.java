...
public class NonBlockingHashMap<TypeK, TypeV> extends AbstractMap<TypeK, TypeV>
  ...
  private static final Object get_impl(final NonBlockingHashMap topmap, final Object[] kvs,
  ...
  private static Object putIfMatch(final NonBlockingHashMap topmap, final Object[] kvs,
   ...
   * {@link java.util.Map.Entry} objects with each iteration. The {@link NonBlockingHashMap} does
  ...
  private static final class CHM<TypeK, TypeV> {
    ...
    private final void copy_check_and_promote(NonBlockingHashMap topmap, Object[] oldkvs,
        int workdone) {
      assert chm(oldkvs) == this;
    ...
    private boolean copy_slot(NonBlockingHashMap topmap, int idx, Object[] oldkvs,
        Object[] newkvs) {
