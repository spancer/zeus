 ...
 * safe, including all update operations. {@link NonBlockingHashtable} scales substatially better
 * than {@link java.util.concurrent.ConcurrentHashMap} for high update rates, even with a large
 ...
 * @author Cliff Click
 * @author Prashant Deva - moved hash() function out of get_impl() so it is not calculated multiple
 * times.
 * @version 1.1.2
 * @since 1.5
 */

public class NonBlockingHashtable<TypeK, TypeV> extends Dictionary<TypeK, TypeV>
  ...
  /**
   * Create a new NonBlockingHashtable with default minimum size (currently set to 8 K/V pairs or
  ...
  /**
   * Create a new NonBlockingHashtable with initial room for the given number of elements, thus
  ...
  private static final Object get_impl(final NonBlockingHashtable topmap, final Object[] kvs,
  ...
  private static final Object putIfMatch(final NonBlockingHashtable topmap, final Object[] kvs,
   ...
   * {@link java.util.Map.Entry} objects with each iteration. The {@link NonBlockingHashtable} does
   * not normally create or using {@link java.util.Map.Entry} objects so they will be created soley
   * to support this iteration. Iterating using {@link #keySet} or {@link #values} will be more
   * efficient.
   */
  @Override
  ...
  private static final class CHM<TypeK, TypeV> {
    ...
    private final void help_copy_impl(NonBlockingHashtable topmap, Object[] oldkvs,
        boolean copy_all) {
    ...
    private final Object[] copy_slot_and_check(NonBlockingHashtable topmap, Object[] oldkvs,
    ...
    private final void copy_check_and_promote(NonBlockingHashtable topmap, Object[] oldkvs,
        int workdone) {
      assert chm(oldkvs) == this;
    ...
    private boolean copy_slot(NonBlockingHashtable topmap, int idx, Object[] oldkvs,
        Object[] newkvs) {
