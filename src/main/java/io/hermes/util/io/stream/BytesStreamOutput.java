...
public class BytesStreamOutput extends StreamOutput {
  ...
  /**
   * Returns the underlying byte array. Note, use {@link #size()} in order to know the length of
   * it.
   */
  ...
  public static class Cached {
    ...
    private static final ThreadLocal<ThreadLocals.CleanableValue<BytesStreamOutput>> cache =
        new ThreadLocal<ThreadLocals.CleanableValue<BytesStreamOutput>>() {
          @Override
          protected ThreadLocals.CleanableValue<BytesStreamOutput> initialValue() {
            return new ThreadLocals.CleanableValue<BytesStreamOutput>(new BytesStreamOutput());
          }
        };

    private static final ThreadLocal<ThreadLocals.CleanableValue<HandlesStreamOutput>> cacheHandles =
        new ThreadLocal<ThreadLocals.CleanableValue<HandlesStreamOutput>>() {
          @Override
          protected ThreadLocals.CleanableValue<HandlesStreamOutput> initialValue() {
            return new ThreadLocals.CleanableValue<HandlesStreamOutput>(
                new HandlesStreamOutput(new BytesStreamOutput()));
          }
        };
