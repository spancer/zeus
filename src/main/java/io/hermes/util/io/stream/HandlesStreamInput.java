...
public class HandlesStreamInput extends StreamInput {
  ...
  public static class Cached {
    ...
    private static final ThreadLocal<ThreadLocals.CleanableValue<HandlesStreamInput>> cache =
        new ThreadLocal<ThreadLocals.CleanableValue<HandlesStreamInput>>() {
          @Override
          protected ThreadLocals.CleanableValue<HandlesStreamInput> initialValue() {
