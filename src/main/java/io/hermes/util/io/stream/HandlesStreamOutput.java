...
import io.hermes.util.trove.ExtTObjectIntHasMap;
...
public class HandlesStreamOutput extends StreamOutput {
  ...
  private final TObjectIntHashMap<String> handles =
      new ExtTObjectIntHasMap<String>().defaultReturnValue(-1);
  ...
  private static class HandleTable {
    ...
    /**
     * Assigns next available handle to given object, and returns handle value. Handles are assigned
    ...
    /**
     * Inserts mapping object -> handle mapping into table. Assumes table is large enough to
     * accommodate new mapping.
     */
    ...
    /**
     * Expands the hash "spine" -- equivalent to increasing the number of buckets in a conventional
     * hash table.
     */
