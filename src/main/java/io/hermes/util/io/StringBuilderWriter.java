...
/**
 * A Writer based on {@link StringBuilder}. Also alows for thread local reuse of {@link
 * StringBuilder} by using: <code>StringBuilderWriter.Cached.cached()</code> in order to obtain the
 * cached writer. Note, in such cases, the {@link #getBuilder()} should be called and used (usually
 * <code>toString</code> it) before another usage of the writer.
 *
 * @author spancer.ray
 */
@NotThreadSafe
public class StringBuilderWriter extends Writer {
  ...
  public static class Cached {
    ...
    private static final ThreadLocal<ThreadLocals.CleanableValue<StringBuilderWriter>> cache =
        new ThreadLocal<ThreadLocals.CleanableValue<StringBuilderWriter>>() {
          @Override
