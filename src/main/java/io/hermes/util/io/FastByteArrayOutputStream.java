...
public class FastByteArrayOutputStream extends OutputStream {
   ...
   * java.nio.charset.Charset charsetName}. The length of the new <tt>String</tt> is a function of
  ...
  public static class Cached {
    ...
    private static final ThreadLocal<ThreadLocals.CleanableValue<FastByteArrayOutputStream>> cache =
        new ThreadLocal<ThreadLocals.CleanableValue<FastByteArrayOutputStream>>() {
          @Override
          protected ThreadLocals.CleanableValue<FastByteArrayOutputStream> initialValue() {
            return new ThreadLocals.CleanableValue<FastByteArrayOutputStream>(
