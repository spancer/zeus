...
public class FastByteArrayInputStream extends InputStream {
  ...
  /**
   * Creates a <code>ByteArrayInputStream</code> so that it uses <code>buf</code> as its buffer
   * array. The buffer array is not copied. The initial value of <code>pos</code> is <code>0</code>
   * and the initial value of <code>count</code> is the length of <code>buf</code>.
   *
  ...
  /**
   * Creates <code>ByteArrayInputStream</code> that uses <code>buf</code> as its buffer array. The
   * initial value of <code>pos</code> is <code>offset</code> and the initial value of
   * <code>count</code> is the minimum of <code>offset+length</code> and <code>buf.length</code>.
   ...
   *                                   negative, or <code>len</code> is greater than <code>b.length
   *                                   - off</code>
   */
   ...
   * method of <code>ByteArrayInputStream</code> always returns <code>true</code>.
   *
   * @since JDK1.1
   */
