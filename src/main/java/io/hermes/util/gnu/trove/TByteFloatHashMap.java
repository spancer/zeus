...
public class TByteFloatHashMap extends TByteHash implements Externalizable {
  ...
  private final TByteFloatProcedure PUT_ALL_PROC = new TByteFloatProcedure() {
  ...
  /**
   * Creates a new <code>TByteFloatHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TByteFloatHashMap</code> instance with a prime capacity equal to or greater
  ...
  /**
   * Creates a new <code>TByteFloatHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TByteFloatHashMap</code> instance with a prime value at or near the
   ...
   */
  public void putAll(TByteFloatHashMap map) {
