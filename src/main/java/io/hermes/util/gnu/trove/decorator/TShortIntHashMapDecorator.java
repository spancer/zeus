...
import io.hermes.util.gnu.trove.TShortIntHashMap;
import io.hermes.util.gnu.trove.TShortIntIterator;
...
/**
 * Wrapper class to make a TShortIntHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TShortIntHashMap and translates the Object-based APIs into their
...
public class TShortIntHashMapDecorator extends AbstractMap<Short, Integer>
   ...
   */
  public TShortIntHashMapDecorator() {
  }
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TShortIntHashMap) in.readObject();
  }
