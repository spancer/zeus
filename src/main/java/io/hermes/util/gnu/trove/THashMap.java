...
public class THashMap<K, V> extends TObjectHash<K> implements Map<K, V>, Externalizable {
  ...
  /**
   * Creates a new <code>THashMap</code> instance with the default capacity and load factor.
   */
  public THashMap() {
    super();
  }
  ...
  public void putAll(Map<? extends K, ? extends V> map) {
    ...
    for (Iterator<? extends Map.Entry<? extends K, ? extends V>> i = map.entrySet().iterator(); i
        .hasNext(); ) {
