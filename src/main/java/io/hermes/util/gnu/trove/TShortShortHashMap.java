...
public class TShortShortHashMap extends TShortHash implements Externalizable {
  ...
  /**
   * Creates a new <code>TShortShortHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TShortShortHashMap</code> instance with a prime capacity equal to or
  ...
  /**
   * Creates a new <code>TShortShortHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TShortShortHashMap</code> instance with a prime value at or near the
   ...
   * @since 2.0b1
   */
  public short adjustOrPutValue(final short key, final short adjust_amount,
