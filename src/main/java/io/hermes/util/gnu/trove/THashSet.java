...
/**
 * An implementation of the <tt>Set</tt> interface that uses an open-addressed hash table to store
 * its contents.
 * <p/>
...
public class THashSet<E> extends TObjectHash<E> implements Set<E>, Iterable<E>, Externalizable {
  ...
  /**
   * Creates a new <code>THashSet</code> instance containing the elements of <tt>collection</tt>.
   *
  ...
  /**
   * Tests the set to determine if all of the elements in <tt>collection</tt> are present.
   *
   * @param collection a <code>Collection</code> value
