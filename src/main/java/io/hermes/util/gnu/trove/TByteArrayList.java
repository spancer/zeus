...
public class TByteArrayList implements Externalizable, Cloneable {
  ...
  /**
   * Creates a new <code>TByteArrayList</code> instance with the specified capacity.
   *
  ...
  /**
   * Creates a new <code>TByteArrayList</code> instance whose capacity is the greater of the length
   ...
   * the array bytes on each resize unless <tt>capacity</tt> requires more than twice the current
   * capacity.
   *
   * @param capacity an <code>int</code> value
   */
   ...
   * @return true if other is a TByteArrayList and has exactly the same values.
   */
