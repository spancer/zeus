...
public class TShortFloatHashMap extends TShortHash implements Externalizable {
  ...
  private final TShortFloatProcedure PUT_ALL_PROC = new TShortFloatProcedure() {
  ...
  /**
   * Creates a new <code>TShortFloatHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TShortFloatHashMap</code> instance with a prime capacity equal to or
  ...
  /**
   * Creates a new <code>TShortFloatHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TShortFloatHashMap</code> instance with a prime value at or near the
   ...
   */
  public void putAll(TShortFloatHashMap map) {
  ...
  public short[] keys(short[] a) {
    int size = size();
    if (a.length < size) {
      a = (short[]) java.lang.reflect.Array.newInstance(a.getClass().getComponentType(), size);
    }
   ...
   * @since 2.0b1
   */
  public float adjustOrPutValue(final short key, final float adjust_amount,
