...
import io.hermes.util.gnu.trove.TByteIntHashMap;
import io.hermes.util.gnu.trove.TByteIntIterator;
...
/**
 * Wrapper class to make a TByteIntHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TByteIntHashMap and translates the Object-based APIs into their
...
public class TByteIntHashMapDecorator extends AbstractMap<Byte, Integer>
   ...
   */
  public TByteIntHashMapDecorator() {
  }
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TByteIntHashMap) in.readObject();
  }
