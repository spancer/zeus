...
import io.hermes.util.gnu.trove.TShortHashSet;
import io.hermes.util.gnu.trove.TShortIterator;
...
/**
 * Wrapper class to make a TShortHashSet conform to the <tt>java.util.Set</tt> API. This class
 * simply decorates an underlying TShortHashSet and translates the Object-based APIs into their
