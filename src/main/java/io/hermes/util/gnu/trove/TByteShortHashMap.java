...
public class TByteShortHashMap extends TByteHash implements Externalizable {
  ...
  private final TByteShortProcedure PUT_ALL_PROC = new TByteShortProcedure() {
  ...
  /**
   * Creates a new <code>TByteShortHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TByteShortHashMap</code> instance with a prime capacity equal to or greater
  ...
  /**
   * Creates a new <code>TByteShortHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TByteShortHashMap</code> instance with a prime value at or near the
