...
import io.hermes.util.gnu.trove.TLongIntHashMap;
import io.hermes.util.gnu.trove.TLongIntIterator;
...
/**
 * Wrapper class to make a TLongIntHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TLongIntHashMap and translates the Object-based APIs into their
...
public class TLongIntHashMapDecorator extends AbstractMap<Long, Integer>
   ...
   */
  public TLongIntHashMapDecorator() {
  }
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TLongIntHashMap) in.readObject();
  }
