...
public class TByteHashSet extends TByteHash implements Externalizable {
  ...
  /**
   * Creates a new <code>TByteHashSet</code> instance with the default capacity and load factor.
   */
  public TByteHashSet() {
    super();
  }
  ...
  /**
   * Creates a new <code>TByteHashSet</code> instance with a prime capacity equal to or greater
   * than
  ...
  /**
   * Creates a new <code>TByteHashSet</code> instance containing the elements of <tt>array</tt>.
   *
  ...
  /**
   * Creates a new <code>TByteHash</code> instance with the default capacity and load factor.
   *
  ...
  /**
   * Creates a new <code>TByteHash</code> instance whose capacity is the next highest prime above
  ...
  /**
   * Creates a new <code>TByteHash</code> instance with a prime value at or near the specified
