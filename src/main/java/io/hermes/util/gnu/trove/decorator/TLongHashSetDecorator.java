...
import io.hermes.util.gnu.trove.TLongHashSet;
import io.hermes.util.gnu.trove.TLongIterator;
...
/**
 * Wrapper class to make a TLongHashSet conform to the <tt>java.util.Set</tt> API. This class simply
 * decorates an underlying TLongHashSet and translates the Object-based APIs into their Trove
 * primitive analogs.
 * <p/>
 * <p/>
 ...
 */
public class TLongHashSetDecorator extends AbstractSet<Long> implements Set<Long>, Externalizable {
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // SET
    _set = (TLongHashSet) in.readObject();
  }
