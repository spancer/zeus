...
public class TFloatArrayList implements Externalizable, Cloneable {
  ...
  /**
   * Creates a new <code>TFloatArrayList</code> instance with the default capacity.
   */
  ...
  /**
   * Creates a new <code>TFloatArrayList</code> instance with the specified capacity.
   *
  ...
  /**
   * Creates a new <code>TFloatArrayList</code> instance whose capacity is the greater of the length
   ...
   * the array floats on each resize unless <tt>capacity</tt> requires more than twice the current
   * capacity.
   *
   * @param capacity an <code>int</code> value
   */
   ...
   * @return true if other is a TFloatArrayList and has exactly the same values.
   */
