...
public class TDoubleShortHashMap extends TDoubleHash implements Externalizable {
  ...
  private final TDoubleShortProcedure PUT_ALL_PROC = new TDoubleShortProcedure() {
  ...
  /**
   * Creates a new <code>TDoubleShortHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TDoubleShortHashMap</code> instance with a prime capacity equal to or
  ...
  /**
   * Creates a new <code>TDoubleShortHashMap</code> instance whose capacity is the next highest
  ...
  /**
   * Creates a new <code>TDoubleShortHashMap</code> instance with a prime value at or near the
   ...
   * @since 2.0b1
   */
  public short adjustOrPutValue(final double key, final short adjust_amount,
