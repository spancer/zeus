...
import io.hermes.util.gnu.trove.TShortByteHashMap;
import io.hermes.util.gnu.trove.TShortByteIterator;
...
/**
 * Wrapper class to make a TShortByteHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TShortByteHashMap and translates the Object-based APIs into their
