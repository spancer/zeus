...
import io.hermes.util.gnu.trove.TObjectLongHashMap;
import io.hermes.util.gnu.trove.TObjectLongIterator;
...
/**
 * Wrapper class to make a TObjectLongHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TObjectLongHashMap and translates the Object-based APIs into their
