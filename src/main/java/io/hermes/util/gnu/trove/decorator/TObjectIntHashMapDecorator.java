...
import io.hermes.util.gnu.trove.TObjectIntIterator;
...
/**
 * Wrapper class to make a TObjectIntHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TObjectIntHashMap and translates the Object-based APIs into their
