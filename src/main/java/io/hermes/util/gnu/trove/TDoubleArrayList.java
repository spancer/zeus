...
public class TDoubleArrayList implements Externalizable, Cloneable {
  ...
  /**
   * Creates a new <code>TDoubleArrayList</code> instance with the default capacity.
   */
  ...
  /**
   * Creates a new <code>TDoubleArrayList</code> instance with the specified capacity.
   *
  ...
  /**
   * Creates a new <code>TDoubleArrayList</code> instance whose capacity is the greater of the
   * length of <tt>values</tt> and DEFAULT_CAPACITY and whose initial contents are the specified
   * values.
   *
   ...
   * the array doubles on each resize unless <tt>capacity</tt> requires more than twice the current
   * capacity.
   *
   * @param capacity an <code>int</code> value
   */
   ...
   * @return true if other is a TDoubleArrayList and has exactly the same values.
   */
