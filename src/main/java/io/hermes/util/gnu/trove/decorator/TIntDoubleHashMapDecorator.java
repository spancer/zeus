...
import io.hermes.util.gnu.trove.TIntDoubleHashMap;
import io.hermes.util.gnu.trove.TIntDoubleIterator;
...
/**
 * Wrapper class to make a TIntDoubleHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TIntDoubleHashMap and translates the Object-based APIs into their
