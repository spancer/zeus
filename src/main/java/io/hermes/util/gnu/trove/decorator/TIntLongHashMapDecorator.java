...
import io.hermes.util.gnu.trove.TIntLongHashMap;
import io.hermes.util.gnu.trove.TIntLongIterator;
...
/**
 * Wrapper class to make a TIntLongHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TIntLongHashMap and translates the Object-based APIs into their
