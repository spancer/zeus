...
public class TShortHashSet extends TShortHash implements Externalizable {
  ...
  /**
   * Creates a new <code>TShortHashSet</code> instance with the default capacity and load factor.
   */
  ...
  /**
   * Creates a new <code>TShortHashSet</code> instance with a prime capacity equal to or greater
  ...
  /**
   * Creates a new <code>TShortHashSet</code> instance containing the elements of <tt>array</tt>.
   *
  ...
  /**
   * Creates a new <code>TShortHash</code> instance with the default capacity and load factor.
   *
  ...
  /**
   * Creates a new <code>TShortHash</code> instance whose capacity is the next highest prime above
  ...
  /**
   * Creates a new <code>TShortHash</code> instance with a prime value at or near the specified
