...
public class TShortDoubleHashMap extends TShortHash implements Externalizable {
  ...
  private final TShortDoubleProcedure PUT_ALL_PROC = new TShortDoubleProcedure() {
  ...
  /**
   * Creates a new <code>TShortDoubleHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TShortDoubleHashMap</code> instance with a prime capacity equal to or
  ...
  /**
   * Creates a new <code>TShortDoubleHashMap</code> instance whose capacity is the next highest
  ...
  /**
   * Creates a new <code>TShortDoubleHashMap</code> instance with a prime value at or near the
   ...
   * @since 2.0b1
   */
  public double adjustOrPutValue(final short key, final double adjust_amount,
