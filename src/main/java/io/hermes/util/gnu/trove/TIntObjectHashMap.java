...
public class TIntObjectHashMap<V> extends TIntHash implements Externalizable {
  ...
  /**
   * Creates a new <code>TIntObjectHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TIntObjectHashMap</code> instance with a prime capacity equal to or greater
  ...
  /**
   * Creates a new <code>TIntObjectHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TIntObjectHashMap</code> instance with a prime value at or near the
   ...
   * @throws ArrayStoreException  the runtime type of the specified array is not a supertype of the
