...
public class TByteIntHashMap extends TByteHash implements Externalizable {
  ...
  private final TByteIntProcedure PUT_ALL_PROC = new TByteIntProcedure() {
  ...
  /**
   * Creates a new <code>TByteIntHashMap</code> instance with the default capacity and load factor.
   */
  ...
  /**
   * Creates a new <code>TByteIntHashMap</code> instance with a prime capacity equal to or greater
  ...
  /**
   * Creates a new <code>TByteIntHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TByteIntHashMap</code> instance with a prime value at or near the specified
   ...
   */
  public void putAll(TByteIntHashMap map) {
