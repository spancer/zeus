...
import io.hermes.util.gnu.trove.TDoubleObjectHashMap;
import io.hermes.util.gnu.trove.TDoubleObjectIterator;
...
/**
 * Wrapper class to make a TDoubleObjectHashMap conform to the <tt>java.util.Map</tt> API. This
 * class simply decorates an underlying TDoubleObjectHashMap and translates the Object-based APIs
...
public class TDoubleObjectHashMapDecorator<V> extends AbstractMap<Double, V>
   ...
   */
  public TDoubleObjectHashMapDecorator() {
  }
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TDoubleObjectHashMap<V>) in.readObject();
  }
