...
public class TDoubleLongHashMap extends TDoubleHash implements Externalizable {
  ...
  private final TDoubleLongProcedure PUT_ALL_PROC = new TDoubleLongProcedure() {
  ...
  /**
   * Creates a new <code>TDoubleLongHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TDoubleLongHashMap</code> instance with a prime capacity equal to or
  ...
  /**
   * Creates a new <code>TDoubleLongHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TDoubleLongHashMap</code> instance with a prime value at or near the
   ...
   */
  public void putAll(TDoubleLongHashMap map) {
