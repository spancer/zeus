...
import io.hermes.util.gnu.trove.TIntFloatHashMap;
import io.hermes.util.gnu.trove.TIntFloatIterator;
...
/**
 * Wrapper class to make a TIntFloatHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TIntFloatHashMap and translates the Object-based APIs into their
...
public class TIntFloatHashMapDecorator extends AbstractMap<Integer, Float>
   ...
   */
  public TIntFloatHashMapDecorator() {
  }
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TIntFloatHashMap) in.readObject();
  }
