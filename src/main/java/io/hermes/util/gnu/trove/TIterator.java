...
/**
 * Abstract iterator class for THash implementations. This class provides some of the common
 * iterator operations (hasNext(), remove()) and allows subclasses to define the mechanism(s) for
 * advancing the iterator and returning data.
 *
