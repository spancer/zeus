...
public class TDoubleFloatHashMap extends TDoubleHash implements Externalizable {
  ...
  private final TDoubleFloatProcedure PUT_ALL_PROC = new TDoubleFloatProcedure() {
  ...
  /**
   * Creates a new <code>TDoubleFloatHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TDoubleFloatHashMap</code> instance with a prime capacity equal to or
  ...
  /**
   * Creates a new <code>TDoubleFloatHashMap</code> instance whose capacity is the next highest
  ...
  /**
   * Creates a new <code>TDoubleFloatHashMap</code> instance with a prime value at or near the
   ...
   * @since 2.0b1
   */
  public float adjustOrPutValue(final double key, final float adjust_amount,
