...
import io.hermes.util.gnu.trove.TFloatFloatHashMap;
import io.hermes.util.gnu.trove.TFloatFloatIterator;
...
/**
 * Wrapper class to make a TFloatFloatHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TFloatFloatHashMap and translates the Object-based APIs into their
...
public class TFloatFloatHashMapDecorator extends AbstractMap<Float, Float>
   ...
   */
  public TFloatFloatHashMapDecorator() {
  }
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TFloatFloatHashMap) in.readObject();
  }
