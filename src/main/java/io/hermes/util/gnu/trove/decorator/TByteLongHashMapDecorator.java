...
import io.hermes.util.gnu.trove.TByteLongHashMap;
import io.hermes.util.gnu.trove.TByteLongIterator;
...
/**
 * Wrapper class to make a TByteLongHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TByteLongHashMap and translates the Object-based APIs into their
