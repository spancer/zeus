...
import io.hermes.util.gnu.trove.TShortShortHashMap;
import io.hermes.util.gnu.trove.TShortShortIterator;
...
/**
 * Wrapper class to make a TShortShortHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TShortShortHashMap and translates the Object-based APIs into their
