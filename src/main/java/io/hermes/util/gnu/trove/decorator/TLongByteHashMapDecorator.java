...
import io.hermes.util.gnu.trove.TLongByteHashMap;
import io.hermes.util.gnu.trove.TLongByteIterator;
...
/**
 * Wrapper class to make a TLongByteHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TLongByteHashMap and translates the Object-based APIs into their
