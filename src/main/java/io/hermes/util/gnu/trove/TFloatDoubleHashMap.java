...
public class TFloatDoubleHashMap extends TFloatHash implements Externalizable {
  ...
  /**
   * Creates a new <code>TFloatDoubleHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TFloatDoubleHashMap</code> instance with a prime capacity equal to or
  ...
  /**
   * Creates a new <code>TFloatDoubleHashMap</code> instance whose capacity is the next highest
  ...
  /**
   * Creates a new <code>TFloatDoubleHashMap</code> instance with a prime value at or near the
   ...
   * @since 2.0b1
   */
  public double adjustOrPutValue(final float key, final double adjust_amount,
