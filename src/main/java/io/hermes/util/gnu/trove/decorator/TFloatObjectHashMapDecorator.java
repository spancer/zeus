...
import io.hermes.util.gnu.trove.TFloatObjectHashMap;
import io.hermes.util.gnu.trove.TFloatObjectIterator;
...
/**
 * Wrapper class to make a TFloatObjectHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TFloatObjectHashMap and translates the Object-based APIs into
...
public class TFloatObjectHashMapDecorator<V> extends AbstractMap<Float, V>
   ...
   */
  public TFloatObjectHashMapDecorator() {
  }
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TFloatObjectHashMap<V>) in.readObject();
  }
