...
import io.hermes.util.gnu.trove.TByteByteHashMap;
import io.hermes.util.gnu.trove.TByteByteIterator;
...
/**
 * Wrapper class to make a TByteByteHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TByteByteHashMap and translates the Object-based APIs into their
