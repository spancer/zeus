...
import io.hermes.util.gnu.trove.TDoubleDoubleHashMap;
import io.hermes.util.gnu.trove.TDoubleDoubleIterator;
...
/**
 * Wrapper class to make a TDoubleDoubleHashMap conform to the <tt>java.util.Map</tt> API. This
 * class simply decorates an underlying TDoubleDoubleHashMap and translates the Object-based APIs
