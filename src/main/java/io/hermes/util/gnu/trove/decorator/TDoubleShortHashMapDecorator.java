...
import io.hermes.util.gnu.trove.TDoubleShortHashMap;
import io.hermes.util.gnu.trove.TDoubleShortIterator;
...
/**
 * Wrapper class to make a TDoubleShortHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TDoubleShortHashMap and translates the Object-based APIs into
