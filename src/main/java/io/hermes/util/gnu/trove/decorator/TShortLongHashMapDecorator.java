...
import io.hermes.util.gnu.trove.TShortLongHashMap;
import io.hermes.util.gnu.trove.TShortLongIterator;
...
/**
 * Wrapper class to make a TShortLongHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TShortLongHashMap and translates the Object-based APIs into their
