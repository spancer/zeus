...
import io.hermes.util.gnu.trove.TByteHashSet;
import io.hermes.util.gnu.trove.TByteIterator;
...
/**
 * Wrapper class to make a TByteHashSet conform to the <tt>java.util.Set</tt> API. This class simply
 * decorates an underlying TByteHashSet and translates the Object-based APIs into their Trove
 * primitive analogs.
 * <p/>
 * <p/>
