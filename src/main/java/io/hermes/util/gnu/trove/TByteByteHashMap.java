...
public class TByteByteHashMap extends TByteHash implements Externalizable {
  ...
  private final TByteByteProcedure PUT_ALL_PROC = new TByteByteProcedure() {
  ...
  /**
   * Creates a new <code>TByteByteHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TByteByteHashMap</code> instance with a prime capacity equal to or greater
  ...
  /**
   * Creates a new <code>TByteByteHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TByteByteHashMap</code> instance with a prime value at or near the
   ...
   */
  public void putAll(TByteByteHashMap map) {
