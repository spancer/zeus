...
import io.hermes.util.gnu.trove.TLongFloatHashMap;
import io.hermes.util.gnu.trove.TLongFloatIterator;
...
/**
 * Wrapper class to make a TLongFloatHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TLongFloatHashMap and translates the Object-based APIs into their
...
public class TLongFloatHashMapDecorator extends AbstractMap<Long, Float>
   ...
   */
  public TLongFloatHashMapDecorator() {
  }
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TLongFloatHashMap) in.readObject();
  }
