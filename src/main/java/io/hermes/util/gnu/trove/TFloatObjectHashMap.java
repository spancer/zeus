...
public class TFloatObjectHashMap<V> extends TFloatHash implements Externalizable {
  ...
  /**
   * Creates a new <code>TFloatObjectHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TFloatObjectHashMap</code> instance with a prime capacity equal to or
  ...
  /**
   * Creates a new <code>TFloatObjectHashMap</code> instance whose capacity is the next highest
  ...
  /**
   * Creates a new <code>TFloatObjectHashMap</code> instance with a prime value at or near the
