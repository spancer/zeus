...
import io.hermes.util.gnu.trove.TShortDoubleHashMap;
import io.hermes.util.gnu.trove.TShortDoubleIterator;
...
/**
 * Wrapper class to make a TShortDoubleHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TShortDoubleHashMap and translates the Object-based APIs into
