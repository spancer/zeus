...
public class TByteObjectHashMap<V> extends TByteHash implements Externalizable {
  ...
  /**
   * Creates a new <code>TByteObjectHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TByteObjectHashMap</code> instance with a prime capacity equal to or
  ...
  /**
   * Creates a new <code>TByteObjectHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TByteObjectHashMap</code> instance with a prime value at or near the
