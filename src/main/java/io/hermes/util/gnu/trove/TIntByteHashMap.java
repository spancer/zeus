...
public class TIntByteHashMap extends TIntHash implements Externalizable {
  ...
  private final TIntByteProcedure PUT_ALL_PROC = new TIntByteProcedure() {
  ...
  /**
   * Creates a new <code>TIntByteHashMap</code> instance with the default capacity and load factor.
   */
  ...
  /**
   * Creates a new <code>TIntByteHashMap</code> instance with a prime capacity equal to or greater
  ...
  /**
   * Creates a new <code>TIntByteHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TIntByteHashMap</code> instance with a prime value at or near the specified
   ...
   */
  public void putAll(TIntByteHashMap map) {
