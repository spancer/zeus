...
public class TLongObjectHashMap<V> extends TLongHash implements Externalizable {
  ...
  /**
   * Creates a new <code>TLongObjectHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TLongObjectHashMap</code> instance with a prime capacity equal to or
  ...
  /**
   * Creates a new <code>TLongObjectHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TLongObjectHashMap</code> instance with a prime value at or near the
  ...
  public long[] keys(long[] a) {
    int size = size();
    if (a.length < size) {
      a = (long[]) java.lang.reflect.Array.newInstance(a.getClass().getComponentType(), size);
    }
