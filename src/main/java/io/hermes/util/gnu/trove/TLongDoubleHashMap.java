...
public class TLongDoubleHashMap extends TLongHash implements Externalizable {
  ...
  /**
   * Creates a new <code>TLongDoubleHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TLongDoubleHashMap</code> instance with a prime capacity equal to or
  ...
  /**
   * Creates a new <code>TLongDoubleHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TLongDoubleHashMap</code> instance with a prime value at or near the
   ...
   * @since 2.0b1
   */
  public double adjustOrPutValue(final long key, final double adjust_amount,
