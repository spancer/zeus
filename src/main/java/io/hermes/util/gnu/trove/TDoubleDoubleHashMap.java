...
public class TDoubleDoubleHashMap extends TDoubleHash implements Externalizable {
  ...
  private final TDoubleDoubleProcedure PUT_ALL_PROC = new TDoubleDoubleProcedure() {
  ...
  /**
   * Creates a new <code>TDoubleDoubleHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TDoubleDoubleHashMap</code> instance with a prime capacity equal to or
  ...
  /**
   * Creates a new <code>TDoubleDoubleHashMap</code> instance whose capacity is the next highest
  ...
  /**
   * Creates a new <code>TDoubleDoubleHashMap</code> instance with a prime value at or near the
   ...
   */
  public void putAll(TDoubleDoubleHashMap map) {
   ...
   * @since 2.0b1
   */
  public double adjustOrPutValue(final double key, final double adjust_amount,
