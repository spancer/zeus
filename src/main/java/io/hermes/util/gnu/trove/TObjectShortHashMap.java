...
public class TObjectShortHashMap<K> extends TObjectHash<K> implements Externalizable {
  ...
  /**
   * Creates a new <code>TObjectShortHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TObjectShortHashMap</code> instance with a prime capacity equal to or
  ...
  /**
   * Creates a new <code>TObjectShortHashMap</code> instance whose capacity is the next highest
  ...
  /**
   * Creates a new <code>TObjectShortHashMap</code> instance with a prime value at or near the
