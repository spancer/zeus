...
import io.hermes.util.gnu.trove.TObjectFloatIterator;
...
/**
 * Wrapper class to make a TObjectFloatHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TObjectFloatHashMap and translates the Object-based APIs into
