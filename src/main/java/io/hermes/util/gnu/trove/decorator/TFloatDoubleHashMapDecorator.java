...
import io.hermes.util.gnu.trove.TFloatDoubleHashMap;
import io.hermes.util.gnu.trove.TFloatDoubleIterator;
...
/**
 * Wrapper class to make a TFloatDoubleHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TFloatDoubleHashMap and translates the Object-based APIs into
