...
import io.hermes.util.gnu.trove.TLongShortHashMap;
import io.hermes.util.gnu.trove.TLongShortIterator;
...
/**
 * Wrapper class to make a TLongShortHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TLongShortHashMap and translates the Object-based APIs into their
