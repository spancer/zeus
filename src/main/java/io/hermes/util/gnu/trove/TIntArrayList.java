...
public class TIntArrayList implements Externalizable, Cloneable {
  ...
  /**
   * Creates a new <code>TIntArrayList</code> instance with the specified capacity.
   *
  ...
  /**
   * Creates a new <code>TIntArrayList</code> instance whose capacity is the greater of the length
   ...
   * the array ints on each resize unless <tt>capacity</tt> requires more than twice the current
   * capacity.
   *
   * @param capacity an <code>int</code> value
   */
