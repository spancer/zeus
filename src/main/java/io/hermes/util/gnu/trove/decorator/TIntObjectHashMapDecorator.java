...
import io.hermes.util.gnu.trove.TIntObjectHashMap;
import io.hermes.util.gnu.trove.TIntObjectIterator;
...
/**
 * Wrapper class to make a TIntObjectHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TIntObjectHashMap and translates the Object-based APIs into their
...
public class TIntObjectHashMapDecorator<V> extends AbstractMap<Integer, V>
   ...
   */
  public TIntObjectHashMapDecorator() {
  }
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TIntObjectHashMap<V>) in.readObject();
  }
