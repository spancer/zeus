...
abstract public class THash implements Cloneable, Externalizable {
   ...
   * as you can get in open addressing without hurting performance. Cf. Knuth, Volume 3., Chapter
   * 6.
   */
   ...
   * requiring a rehash.  This is a tuning method you can call before doing a large insert.
   * <p>
  ...
  public void ensureCapacity(int desiredCapacity) {
    if (desiredCapacity > (_maxSize - size())) {
      rehash(PrimeFinder
          .nextPrime(HashFunctions.fastCeil((desiredCapacity + size()) / _loadFactor) + 1));
   ...
   * <tt>REMOVED</tt> slots to skip over when probing for indices in the table.</li>
   * </ol>
   */
  public void compact() {
