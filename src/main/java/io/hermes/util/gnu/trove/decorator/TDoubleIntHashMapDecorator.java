...
import io.hermes.util.gnu.trove.TDoubleIntHashMap;
import io.hermes.util.gnu.trove.TDoubleIntIterator;
...
/**
 * Wrapper class to make a TDoubleIntHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TDoubleIntHashMap and translates the Object-based APIs into their
...
public class TDoubleIntHashMapDecorator extends AbstractMap<Double, Integer>
   ...
   */
  public TDoubleIntHashMapDecorator() {
  }
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TDoubleIntHashMap) in.readObject();
  }
