...
import io.hermes.util.gnu.trove.TByteFloatHashMap;
import io.hermes.util.gnu.trove.TByteFloatIterator;
...
/**
 * Wrapper class to make a TByteFloatHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TByteFloatHashMap and translates the Object-based APIs into their
