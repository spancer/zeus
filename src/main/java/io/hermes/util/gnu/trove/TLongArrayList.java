...
public class TLongArrayList implements Externalizable, Cloneable {
  ...
  /**
   * Creates a new <code>TLongArrayList</code> instance with the specified capacity.
   *
  ...
  /**
   * Creates a new <code>TLongArrayList</code> instance whose capacity is the greater of the length
   ...
   * the array longs on each resize unless <tt>capacity</tt> requires more than twice the current
   * capacity.
   *
   * @param capacity an <code>int</code> value
   */
   ...
   * @return true if other is a TLongArrayList and has exactly the same values.
   */
