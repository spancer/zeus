...
public class TFloatLongHashMap extends TFloatHash implements Externalizable {
  ...
  private final TFloatLongProcedure PUT_ALL_PROC = new TFloatLongProcedure() {
  ...
  /**
   * Creates a new <code>TFloatLongHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TFloatLongHashMap</code> instance with a prime capacity equal to or greater
  ...
  /**
   * Creates a new <code>TFloatLongHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TFloatLongHashMap</code> instance with a prime value at or near the
   ...
   */
  public void putAll(TFloatLongHashMap map) {
