...
import io.hermes.util.gnu.trove.TShortFloatHashMap;
import io.hermes.util.gnu.trove.TShortFloatIterator;
...
/**
 * Wrapper class to make a TShortFloatHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TShortFloatHashMap and translates the Object-based APIs into their
