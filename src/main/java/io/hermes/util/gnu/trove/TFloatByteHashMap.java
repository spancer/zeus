...
public class TFloatByteHashMap extends TFloatHash implements Externalizable {
  ...
  private final TFloatByteProcedure PUT_ALL_PROC = new TFloatByteProcedure() {
  ...
  /**
   * Creates a new <code>TFloatByteHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TFloatByteHashMap</code> instance with a prime capacity equal to or greater
  ...
  /**
   * Creates a new <code>TFloatByteHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TFloatByteHashMap</code> instance with a prime value at or near the
   ...
   */
  public void putAll(TFloatByteHashMap map) {
