...
public class TLongByteHashMap extends TLongHash implements Externalizable {
  ...
  /**
   * Creates a new <code>TLongByteHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TLongByteHashMap</code> instance with a prime capacity equal to or greater
  ...
  /**
   * Creates a new <code>TLongByteHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TLongByteHashMap</code> instance with a prime value at or near the
