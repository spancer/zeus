...
public class TLongHashSet extends TLongHash implements Externalizable {
  ...
  /**
   * Creates a new <code>TLongHashSet</code> instance with a prime capacity equal to or greater
   * than
  ...
  /**
   * Creates a new <code>TLongHashSet</code> instance containing the elements of <tt>array</tt>.
   *
  ...
  /**
   * Creates a new <code>TLongHash</code> instance whose capacity is the next highest prime above
  ...
  /**
   * Creates a new <code>TLongHash</code> instance with a prime value at or near the specified
