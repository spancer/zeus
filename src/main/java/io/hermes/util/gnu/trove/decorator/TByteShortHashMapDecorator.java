...
import io.hermes.util.gnu.trove.TByteShortHashMap;
import io.hermes.util.gnu.trove.TByteShortIterator;
...
/**
 * Wrapper class to make a TByteShortHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TByteShortHashMap and translates the Object-based APIs into their
...
public class TByteShortHashMapDecorator extends AbstractMap<Byte, Short>
   ...
   */
  public TByteShortHashMapDecorator() {
  }
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TByteShortHashMap) in.readObject();
  }
