...
import io.hermes.util.gnu.trove.TIntShortHashMap;
import io.hermes.util.gnu.trove.TIntShortIterator;
...
/**
 * Wrapper class to make a TIntShortHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TIntShortHashMap and translates the Object-based APIs into their
