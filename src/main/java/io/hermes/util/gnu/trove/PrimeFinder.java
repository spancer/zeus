...
/*
 * Modified for Trove to use the java.util.Arrays sort/search algorithms instead of those provided
 * with colt.
 */
 ...
 * <p/>
 * <p>
 * However, JDK 1.2, JGL 3.1 and many other toolkits do nothing to keep capacities prime. This class
 * provides efficient means to choose prime capacities.
 * <p/>
 * <p>
 * Choosing a prime is <tt>O(log 300)</tt> (binary search in a list of 300 ints). Memory
...
public final class PrimeFinder {
   ...
   * <p/>
   * Chunks are chosen such that for any desired capacity >= 1000 the list includes a prime number
   * <= desired capacity * 1.11.
   * <p/>
   * Therefore, primes can be retrieved which are quite close to any desired capacity, which in turn
  ...
  private static final int[] primeCapacities = {
      ...
      // chunk #4
      1039, 2081, 4177, 8363, 16729, 33461, 66923, 133853, 267713, 535481, 1070981, 2141977,
      4283963, 8567929, 17135863, 34271747, 68543509, 137087021, 274174111, 548348231, 1096696463,
  ...
  /**
   * Returns a prime number which is <code>&gt;= desiredCapacity</code> and very close to
   * <code>desiredCapacity</code> (within 11% if <code>desiredCapacity &gt;= 1000</code>).
   *
