...
import io.hermes.util.gnu.trove.TFloatHashSet;
import io.hermes.util.gnu.trove.TFloatIterator;
...
/**
 * Wrapper class to make a TFloatHashSet conform to the <tt>java.util.Set</tt> API. This class
 * simply decorates an underlying TFloatHashSet and translates the Object-based APIs into their
