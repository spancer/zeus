...
public class TFloatFloatHashMap extends TFloatHash implements Externalizable {
  ...
  private final TFloatFloatProcedure PUT_ALL_PROC = new TFloatFloatProcedure() {
  ...
  /**
   * Creates a new <code>TFloatFloatHashMap</code> instance with the default capacity and load
   * factor.
   */
  ...
  /**
   * Creates a new <code>TFloatFloatHashMap</code> instance with a prime capacity equal to or
  ...
  /**
   * Creates a new <code>TFloatFloatHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TFloatFloatHashMap</code> instance with a prime value at or near the
   ...
   */
  public void putAll(TFloatFloatHashMap map) {
   ...
   * @since 2.0b1
   */
  public float adjustOrPutValue(final float key, final float adjust_amount,
