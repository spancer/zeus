...
import io.hermes.util.gnu.trove.TFloatIntHashMap;
import io.hermes.util.gnu.trove.TFloatIntIterator;
...
/**
 * Wrapper class to make a TFloatIntHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TFloatIntHashMap and translates the Object-based APIs into their
