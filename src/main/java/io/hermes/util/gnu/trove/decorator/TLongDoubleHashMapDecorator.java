...
import io.hermes.util.gnu.trove.TLongDoubleHashMap;
import io.hermes.util.gnu.trove.TLongDoubleIterator;
...
/**
 * Wrapper class to make a TLongDoubleHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TLongDoubleHashMap and translates the Object-based APIs into their
...
public class TLongDoubleHashMapDecorator extends AbstractMap<Long, Double>
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TLongDoubleHashMap) in.readObject();
  }
