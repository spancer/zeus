...
import io.hermes.util.gnu.trove.TDoubleFloatHashMap;
import io.hermes.util.gnu.trove.TDoubleFloatIterator;
...
/**
 * Wrapper class to make a TDoubleFloatHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TDoubleFloatHashMap and translates the Object-based APIs into
...
public class TDoubleFloatHashMapDecorator extends AbstractMap<Double, Float>
   ...
   */
  public TDoubleFloatHashMapDecorator() {
  }
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TDoubleFloatHashMap) in.readObject();
  }
