...
import io.hermes.util.gnu.trove.TFloatByteHashMap;
import io.hermes.util.gnu.trove.TFloatByteIterator;
...
/**
 * Wrapper class to make a TFloatByteHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TFloatByteHashMap and translates the Object-based APIs into their
...
public class TFloatByteHashMapDecorator extends AbstractMap<Float, Byte>
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TFloatByteHashMap) in.readObject();
  }
