...
import io.hermes.util.gnu.trove.TLongLongHashMap;
import io.hermes.util.gnu.trove.TLongLongIterator;
...
/**
 * Wrapper class to make a TLongLongHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TLongLongHashMap and translates the Object-based APIs into their
