...
public class TIntLongHashMap extends TIntHash implements Externalizable {
  ...
  /**
   * Creates a new <code>TIntLongHashMap</code> instance with a prime capacity equal to or greater
  ...
  /**
   * Creates a new <code>TIntLongHashMap</code> instance whose capacity is the next highest prime
  ...
  /**
   * Creates a new <code>TIntLongHashMap</code> instance with a prime value at or near the specified
