...
import io.hermes.util.gnu.trove.TFloatLongHashMap;
import io.hermes.util.gnu.trove.TFloatLongIterator;
...
/**
 * Wrapper class to make a TFloatLongHashMap conform to the <tt>java.util.Map</tt> API. This class
 * simply decorates an underlying TFloatLongHashMap and translates the Object-based APIs into their
...
public class TFloatLongHashMapDecorator extends AbstractMap<Float, Long>
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    // MAP
    _map = (TFloatLongHashMap) in.readObject();
  }
