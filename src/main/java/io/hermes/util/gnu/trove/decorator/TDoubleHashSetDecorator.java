...
import io.hermes.util.gnu.trove.TDoubleHashSet;
import io.hermes.util.gnu.trove.TDoubleIterator;
...
/**
 * Wrapper class to make a TDoubleHashSet conform to the <tt>java.util.Set</tt> API. This class
 * simply decorates an underlying TDoubleHashSet and translates the Object-based APIs into their
