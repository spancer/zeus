...
public class JvmConfig implements Streamable, Serializable {
  ...
  static {
    ...
    INSTANCE = new JvmConfig(pid, runtimeMXBean.getVmName(), System.getProperty("java.version"),
        System.getProperty("java.vendor"), runtimeMXBean.getStartTime(),
        ...
        runtimeMXBean.getInputArguments().toArray(
            new String[runtimeMXBean.getInputArguments().size()]),
        runtimeMXBean.getBootClassPath(), runtimeMXBean.getClassPath(),
  ...
  public JvmConfig(long pid, String vmName, String vmVersion, String vmVendor, long startTime,
      ...
      String[] inputArguments, String bootClassPath, String classPath,
