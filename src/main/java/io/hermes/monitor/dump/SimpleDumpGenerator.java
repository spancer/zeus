...
public class SimpleDumpGenerator implements DumpGenerator {
  ...
  public Result generateDump(String cause, @Nullable Map<String, Object> context)
    ...
    return generateDump(cause, context,
        contributors.keySet().toArray(new String[contributors.size()]));
  }
  ...
  public Result generateDump(String cause, @Nullable Map<String, Object> context,
    ...
    ArrayList<DumpContributionFailedException> failedContributors =
        new ArrayList<DumpContributionFailedException>();
    for (String name : contributors) {
      ...
      try {
        ...
        failedContributors
            .add(new DumpContributionFailedException(contributor.getName(), "Failed", e));
      }
    }
    dump.finish();
