...
package io.hermes.threadpool.support;

import io.hermes.threadpool.FutureListener;
...
public abstract class AbstractThreadPool extends AbstractComponent implements ThreadPool {
  ...
  @Override
  public <T> Future<T> submit(Callable<T> task, FutureListener<T> listener) {
  ...
  @Override
  public <T> Future<T> submit(Runnable task, T result, FutureListener<T> listener) {
  ...
  @Override
  public Future<?> submit(Runnable task, FutureListener<?> listener) {
  ...
  public ScheduledFuture<?> scheduleWithFixedDelay(Runnable command, TimeValue interval) {
    return scheduleWithFixedDelay(command, interval.millis(), interval.millis(),
