...
/**
 * A listener that should be called by the {@link io.hermes.discovery.Discovery} component when the
 * first valid initial cluster state has been submitted and processed by the cluster service.
 *
 * <p>
